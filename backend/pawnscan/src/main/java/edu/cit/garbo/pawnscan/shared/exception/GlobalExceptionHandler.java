package edu.cit.garbo.pawnscan.shared.exception;
...
import edu.cit.garbo.pawnscan.features.reports.exception.FileStorageException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUnexpected(Exception ex) {
        ...
        if (ex.getCause() != null) {
            errorInfo += " | Cause: " + ex.getCause().getClass().getName() + ": " + ex.getCause().getMessage();
        }
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, errorInfo);
    }
