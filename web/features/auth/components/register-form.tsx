      ...
      <section className="mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-6xl grid-cols-1 overflow-hidden md:grid-cols-1 lg:grid-cols-2">
        <aside className="relative flex flex-col justify-center p-6 sm:p-8 lg:p-12 lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-[3.5rem] lg:leading-[1.1] text-transparent bg-clip-text bg-gradient-to-br from-white via-slate-200 to-slate-500 pb-2">
        ...
        <section className="flex items-start p-4 sm:p-8 lg:p-12 relative z-10">
          <div className="w-full max-w-[32rem] mx-auto p-8 sm:p-10 rounded-3xl shadow-[0_24px_60px_rgba(0,0,0,0.4)] bg-slate-900/60 border border-slate-700/40 backdrop-blur-2xl relative overflow-hidden transition-all duration-300 hover:shadow-[0_24px_80px_rgba(0,0,0,0.5)] form-fixed thin-scrollbar">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="flex min-h-12 w-full items-center justify-center gap-3 rounded-[10px] bg-slate-800/50 px-3 py-2 text-sm font-semibold text-slate-100 border border-slate-700/50 transition hover:bg-slate-700/50 focus-visible:ring-2 focus-visible:ring-brand/40 active:scale-95"
              >
